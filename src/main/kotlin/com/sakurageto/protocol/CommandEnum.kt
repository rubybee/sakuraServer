...
enum class TokenEnum(var real_number: Int){
    ...
    YOUR_ARTIFICIAL_SAKURA_TOKEN_BURN(4),
    OTHER_ARTIFICIAL_SAKURA_TOKEN(5),
    OTHER_ARTIFICIAL_SAKURA_TOKEN_ON_TOKEN(6),
    OTHER_ARTIFICIAL_SAKURA_TOKEN_OUT_TOKEN(7),
    OTHER_ARTIFICIAL_SAKURA_TOKEN_BURN(8);
    ...
    fun opposite(): TokenEnum{
        return when(this){
            ...
            YOUR_ARTIFICIAL_SAKURA_TOKEN_BURN -> OTHER_ARTIFICIAL_SAKURA_TOKEN_BURN
            ...
            OTHER_ARTIFICIAL_SAKURA_TOKEN_BURN -> YOUR_ARTIFICIAL_SAKURA_TOKEN_BURN
        }
    }
