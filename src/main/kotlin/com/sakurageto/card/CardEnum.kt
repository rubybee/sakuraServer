...
enum class CardName {
    ...
    companion object {
        private val cardNameHashmapFirst = EnumMap<CardName, Int>(CardName::class.java).apply {
            ...
            put(MEGUMI_GONG_SUM, 1900)
            put(MEGUMI_TA_CHEOG, 1901)
            put(MEGUMI_SHELL_ATTACK, 1902)
            put(MEGUMI_POLE_THRUST, 1903)
            put(MEGUMI_REED, 1904)
            put(MEGUMI_BALSAM, 1905)
            put(MEGUMI_WILD_ROSE, 1906)
            put(MEGUMI_ROOT_OF_CAUSALITY, 1907)
            put(MEGUMI_BRANCH_OF_POSSIBILITY, 1908)
            put(MEGUMI_FRUIT_OF_END, 1909)
            put(MEGUMI_MEGUMI_PALM, 1910)

            put(KANAWE_IMAGE, 2000)
            put(KANAWE_SCREENPLAY, 2001)
            put(KANAWE_PRODUCTION, 2002)
            put(KANAWE_PUBLISH, 2003)
            put(KANAWE_AFTERGLOW, 2004)
            put(KANAWE_IMPROMPTU, 2005)
            put(KANAWE_SEAL, 2006)
            put(KANAWE_VAGUE_STORY, 2007)
            put(KANAWE_INFINITE_STARLIGHT, 2008)
            put(KANAWE_BEND_OVER_THIS_NIGHT, 2009)
            put(KANAWE_DISTANT_SKY, 2010)
            put(KANAWE_KANAWE, 2011)

            put(IDEA_SAL_JIN, 9000)
            put(IDEA_SAKURA_WAVE, 9001)
            put(IDEA_WHISTLE, 9002)
        ...
        private val cardNameHashmapSecond = EnumMap<CardName, Int>(CardName::class.java).apply {
            ...
            put(MEGUMI_GONG_SUM, 11900)
            put(MEGUMI_TA_CHEOG, 11901)
            put(MEGUMI_SHELL_ATTACK, 11902)
            put(MEGUMI_POLE_THRUST, 11903)
            put(MEGUMI_REED, 11904)
            put(MEGUMI_BALSAM, 11905)
            put(MEGUMI_WILD_ROSE, 11906)
            put(MEGUMI_ROOT_OF_CAUSALITY, 11907)
            put(MEGUMI_BRANCH_OF_POSSIBILITY, 11908)
            put(MEGUMI_FRUIT_OF_END, 11909)
            put(MEGUMI_MEGUMI_PALM, 11910)

            put(KANAWE_IMAGE, 12000)
            put(KANAWE_SCREENPLAY, 12001)
            put(KANAWE_PRODUCTION, 12002)
            put(KANAWE_PUBLISH, 12003)
            put(KANAWE_AFTERGLOW, 12004)
            put(KANAWE_IMPROMPTU, 12005)
            put(KANAWE_SEAL, 12006)
            put(KANAWE_VAGUE_STORY, 12007)
            put(KANAWE_INFINITE_STARLIGHT, 12008)
            put(KANAWE_BEND_OVER_THIS_NIGHT, 12009)
            put(KANAWE_DISTANT_SKY, 12010)
            put(KANAWE_KANAWE, 12011)

            put(IDEA_SAL_JIN, 19000)
            put(IDEA_SAKURA_WAVE, 19001)
            put(IDEA_WHISTLE, 19002)
